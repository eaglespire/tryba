			...
			<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<td valign="middle" width="40%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;">{!!$from_amount!!}</span>
					</td>
				</tr>								
				<tr>
					<td valign="middle" width="60%" style="text-align:left; padding: 1em 2.5em;">
				...
				<table>
					...
					<tr>
						...
						<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
							<tr>
							<td style="text-align: center; padding-right: 10px; font-size: 12px;">
								<p>If you have an account, please <a href="{{route('user.dashboard')}}">head to your dashboard</a> to see more information on this payment</p>
							</td>
							</tr>
						</table>
						</td>
