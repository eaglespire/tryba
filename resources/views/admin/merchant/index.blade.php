    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12">
                        ...
                        <table class="table table-flush" id="datatable-buttons">
                            ...
                            @foreach($merchant as $k=>$val)
                                <tr>
                                    ...
                                    <td><a href="{{ ($val->user != NULL) ? url('admin/manage-user').'/'. $val->user->id : "" }}">{{ ($val->user != NULL) ? $val->user->first_name.' '.$val->user->last_name : "" }}</a></td>
                                    <td>{{$val->name}}</td>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p>Showing 1 to {{$merchant->count()}} of {{ $merchant->total() }} entries</p>
                    </div>
                    <div class="col-md-6 text-right">
                        {{ $merchant->onEachSide(2)->links() }}
                    </div>
                </div>
            </div>
                </div>
