...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-204139061-1">
</script>
<script>
  ...
  gtag('config', 'UA-204139061-1');
</script>
    </head>
<!-- header begin-->
  <body @if($merchant->checkout_theme!=null) class="{{$merchant->checkout_theme}}" @endif>
