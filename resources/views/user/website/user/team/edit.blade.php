    ...
    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
            ...
            <ul class="breadcrumb fw-bold fs-base my-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{route('website.team')}}" class="text-muted text-hover-primary">{{__('team')}}</a>
                </li>
        ...
        <div class="card">
            <div class="card-header py-5 py-md-0 py-lg-5 py-xxl-0">
                <div class="card-title flex-column">
                    <h3 class="fw-bolder m-0 text-dark">{{__('Edit Team')}}</h3>
                </div>
            </div>
            <div class="card-body px-9 pt-6 pb-4">
                <form action="{{route('update.team.website', ['id'=>$val->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-9">
                            <div class="row mb-6">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-12">
                                    <input type="text" class="form-control form-control-solid" placeholder="{{__('Occupation')}}" value="{{$val->occupation}}" name="occupation">
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-12">
                                    <input type="url" class="form-control form-control-solid" placeholder="{{__('Whatsapp')}}" value="{{$val->whatsapp}}" name="whatsapp">
                                </div>
                            </div>                            
                            <div class="row mb-6">
                                <label class="col-lg-12 col-form-label fw-bold fs-6">{{__('Facebook')}}</label>
                                <div class="col-lg-12">
                                    <input type="url" class="form-control form-control-solid" placeholder="{{__('Facebook')}}" value="{{$val->facebook}}" name="facebook">
                                </div>
                            </div>                            
                            <div class="row mb-6">
                                <label class="col-lg-12 col-form-label fw-bold fs-6">{{__('Linkedin')}}</label>
                                <div class="col-lg-12">
                                    <input type="url" class="form-control form-control-solid" placeholder="{{__('Linkedin')}}" value="{{$val->linkedin}}" name="linkedin">
                                </div>
                            </div>                            
                            <div class="row mb-6">
                                <label class="col-lg-12 col-form-label fw-bold fs-6">{{__('Instagram')}}</label>
                                <div class="col-lg-12">
                                    <input type="url" class="form-control form-control-solid" placeholder="{{__('Instagram')}}" value="{{$val->instagram}}" name="instagram">
                                </div>
                            </div>
                            <div class="row mb-6">
                                <label class="col-lg-12 col-form-label fw-bold fs-6">{{__('Twitter')}}</label>
                                <div class="col-lg-12">
                                    <input type="url" class="form-control form-control-solid" placeholder="{{__('Twitter')}}" value="{{$val->twitter}}" name="twitter">
                                </div>
                            </div>
                            <div class="row mb-6">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-12">
                                    <div class="image-input image-input-outline mb-5" data-kt-image-input="true" style="background-image: url({{asset('asset/new_dashboard/media/avatars/blank.png')}})">
                                        ...
                                        <div class="image-input-wrapper w-150px h-150px" style="background-image: url({{ $val->image }})"></div>
