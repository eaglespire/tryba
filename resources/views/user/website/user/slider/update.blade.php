    ...
    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
            ...
            <ul class="breadcrumb fw-bold fs-base my-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{route('website.theme')}}" class="text-muted text-hover-primary">{{__('Themes')}}</a>
                </li>
                <li class="breadcrumb-item text-muted">
...
<div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
    <div class="container">
        <div class="card">
            ...
            <form action="{{route('update.slider.website', ['id'=> $key  ])}}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-solid" value="{{ $slide['title1'] }}" placeholder="{{__('Text 1')}}" name="title1">
                                </div>
                            </div>
                            <div class="row mb-6">
                                <label class="col-lg-3 col-form-label fw-bold fs-6">{{__('Text 2')}}</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-solid" value="{{ $slide['title2'] }}" placeholder="{{__('Text 2')}}" name="title2">
                                </div>
                            </div>
                            <div class="row mb-6">
                                <label class="col-lg-3 col-form-label fw-bold fs-6">{{__('Text 3')}}</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-solid" value="{{ $slide['title3'] }}" placeholder="{{__('Text 3')}}" name="title3">
                                </div>
                            </div>
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-9">
                                    <select name="status" class="form-select form-select-solid" required>
                                        <option value='0' @if($slide['status'] == 0) selected @endif>No</option>
                                        <option value='1' @if($slide['status'] == 1) selected @endif>Yes</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-check form-check-solid mb-6">
                                <input name="button_status" class="form-check-input" type="checkbox" id="buttonStatus" value="1" @if(!empty($slide['button_text'])) checked @endif>
                                <label class="form-check-label fw-bold ps-2 fs-6" for="buttonStatus">{{__('Button Status')}}</label>
                            </div>
                            <div @if(!empty($slide['button_text']))  style="display:none;" @endif id="buttonStatusDisplay">
                                <div class="d-flex flex-column mb-5 fv-row fv-plugins-icon-container">
                                    <label class="required fs-5 fw-bold mb-2">{{__('Text')}}</label>
                                    <input type="text" class="form-control form-control-solid" id="button_text" value="{{ $slide['button_text'] }}" maxlength="40" placeholder="{{__('Text')}}" name="button_text">
                                </div>
                                <div class="d-flex flex-column mb-5 fv-row fv-plugins-icon-container">
                                    <label class="required fs-5 fw-bold mb-2">{{__('Link')}}</label>
                                    <input type="url" class="form-control form-control-solid" id="button_link" value="{{ $slide['button_link'] }}" placeholder="{{__('Link')}}" name="button_link">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-12">
                                    <div class="image-input image-input-outline mb-5" data-kt-image-input="true">
                                        ...
                                        <div class="image-input-wrapper w-250px h-150px" style="background-image: url({{ $slide['url'] }})"></div>
