		...
		<div class="lazyload subpage-bg-right subpage-bg__position01" data-bg="images/wrapper-subpage-right.png">
				...
				<div class="container container-fluid-lg">
					<div class="layout01">
						<div class="layout01__img">
							<img class="tt-arrow" src="images/arrow-img-right.png" alt="">
							<div class="tt-img-main">
								<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{  asset('asset/themes/website/prolaundry/images/layout01-img01.jpg') }}" class="lazyload" alt="">
							</div>
							<div class="tt-img-more left-bottom">
								<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{  asset('asset/themes/website/prolaundry/images/layout01-img02.jpg') }}" class="lazyload" alt="">
							</div>
						</div>
							...
							<div class="layout01__content-wrapper">
								<div class="title-block">
									...
									<h4 class="title-block__title">
										Your Dry Cleaning and Laundry. Done.
									</h4>
								</div>
								<p>
				...
				<div class="container-fluid no-gutters">
					<div class="box02 box02__img-right box02-notover">
						<div class="box02__img">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="lazyload" data-src="{{  asset('asset/themes/website/prolaundry/images/box02-img04.jpg') }}" alt="">
						...
						<div class="box02__content box02__content-variant02">
							<div class="title-block">
								...
								<h4 class="title-block__title">
									The Best Guarantee <br>in the Business
								</h4>
							</div>
							<p>
								The most trusted brand in clothing care since 2011. We will do everything we can to return your clothes to you in great shape. In the rare instance that an item goes missing or is damaged during the cleaning process, we’ll reimburse you up to the full value of the item with a $1,000 maximum per order.
							</p>
					...
					<div class="added-info02 row">
						<a href="contact-areas.html" class="added-info02__item col-md-4">
							...
							<div class="added-info02__description">
								<h6 class="added-info02__title"><span>Persionalized Experience</span></h6>
						...
						<a href="#" class="added-info02__item col-md-4">
							...
							<div class="added-info02__description">
								<h6 class="added-info02__title"><span>Quality</span></h6>
						...
						<a href="#" class="added-info02__item col-md-4">
							...
							<div class="added-info02__description">
								<h6 class="added-info02__title"><span>Express Delivery</span></h6>
						...
						<a href="#" class="added-info02__item col-md-4">
							...
							<div class="added-info02__description">
								<h6 class="added-info02__title"><span>Instant Order Update</span></h6>
			...
			<div class="section-indent">
				<div class="box02 box02__img-left">
					<div class="box02__img">
						<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="lazyload" data-src="{{  asset('asset/themes/website/prolaundry/images/box02-img03.jpg') }}" alt="">
						<img class="tt-arrow" src="{{  asset('asset/themes/website/prolaundry/images/arrow-img-right03.png') }}" alt="">
					</div>
				...
				<div class="container container-fluid-lg">
					<div class="title-block text-center">
						...
						<div class="title-block__text">
							Our team’s goal each day is to earn your business with each visit and to make<br> your experience with us the absolute best.
						</div>
					</div>
					<div class="row slick-default" data-slick='{
								"slidesToShow": 3,
						...
						<div class="col-md-4">
							<a href="#" class="pesonal-info">
								<div class="pesonal-info__img">
									<img src="{{  asset('asset/themes/website/prolaundry/images/pesonal-info-img01.jpg') }}" alt="">
								</div>
						...
						<div class="col-md-4">
							<a href="#" class="pesonal-info">
								<div class="pesonal-info__img">
									<img src="{{  asset('asset/themes/website/prolaundry/images/pesonal-info-img02.jpg') }}" alt="">
								</div>
						...
						<div class="col-md-4">
							<a href="#" class="pesonal-info">
								<div class="pesonal-info__img">
									<img src="{{  asset('asset/themes/website/prolaundry/images/pesonal-info-img03.jpg') }}" alt="">
								</div>
