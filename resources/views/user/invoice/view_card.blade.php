              ...
              <div class="col-lg-6">
                ...
                <div class="d-flex flex-column py-1">
                  ...
                  <div class="text-dark fw-bold fs-6 mb-4">
                    ...
                    @endif {{$link->customer->first_name.' '.$link->customer->last_name}}<br /><br />{{$link->customer->email}}<br />{{$link->customer->phone}}<br /><br />
                ...
                @if(!empty($merchant->gBPAccount()->accountNumber) AND !empty($merchant->gBPAccount()->sortCode))
                  <div class="bg-gray rounded mb-3">
                    <div class="custom-control custom-control-alternative custom-radio">
                      ...
                      <label class="custom-control-label text-dark" for="customCheckgLogin">
                        {{__('Pay with Open Banking')}}
                      </label>
                    </div>
                  </div>
                @endif
                @if(!empty($merchant->paypal_client_id) && !empty($merchant->paypal_secret_key))
                  <div class="bg-gray rounded mb-3">
                    <div class="custom-control custom-control-alternative custom-radio">
                      <input class="custom-control-input" id="customCheckxLogin" type="radio" name="action" value="paypal" required>
                      <label class="custom-control-label text-dark" for="customCheckxLogin">
                        {{__('Pay with Paypal')}}
                      </label>
                    </div>
                  </div>
                ...
                @if(false)
                  <div class="bg-gray rounded mb-3">
                    <div class="custom-control custom-control-alternative custom-radio">
                      ...
                      <label class="custom-control-label text-dark" for="customCheckdLogin">
