                        ...
                        <td>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                ...
                                @if(!empty($item->invoiceurl))
                                    <div class="menu-item px-3"><a href="{{ $item->invoiceurl }}" class="menu-link px-3">{{__('View invoice')}}</a></div>
                                @endif
                                    <div class="menu-item px-3"><a href="{{ route('show.update.expense',$item->id) }}" class="menu-link px-3">{{__('Edit')}}</a></div>
                    ...
                    <div class="modal-body mt-4">
                        <div class="card bg-white border-0 mb-0">
                            ...
                            <div class="card-body d-flex px-lg-5 py-lg-5 text-right">
                                ...
                                <form method="post" action="{{ route('delete.expense', $item->id) }}">
                                    @csrf
                                    @method('delete')
