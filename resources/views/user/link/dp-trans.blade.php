...
<div class="toolbar" id="kt_toolbar">
    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-nowrap text-nowrap py-1">
            <a href="#" class="btn btn-white btn-active-primary me-4 btn-color-dark" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">Archived ({{$archivesum}})</a>
        </div>
    </div>
</div>
                            ...
                            <div class="px-7 py-5" data-kt-user-table-filter="form">
                                ...
                                <div class="mb-10">
                                    ...
                                    <select class="form-select form-select-solid" name="status" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true">
                                        ...
                                        <option value="2">{{__('Failed/Cancelled')}}</option>
                                    </select>
                                </div>
                                <div class="mb-10">
                                    <label class="form-label fs-6 fw-bold">{{__('Payment')}}</label>
                                    <select class="form-select form-select-solid" name="payment" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true">
                                        <option value="0">{{__('All')}}</option>
                                        <option value="1">{{__('Single Pot')}}</option>
                                        <option value="2">{{__('Gig Pot')}}</option>
                                        <option value="3">{{__('Invoice')}}</option>
                                        <option value="4">{{__('Merchant')}}</option>
                                        <option value="7">{{__('Product Order')}}</option>
                                        <option value="8">{{__('Store Order')}}</option>
                                        <option value="9">{{__('Subscription')}}</option>
                                    </select>
                                </div>
                                <div class="mb-10">
                                    <label class="form-label fs-6 fw-bold">{{__('Method')}}</label>
                                    <select class="form-select form-select-solid" name="method" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true">
                                        <option value="Administrator">All</option>
                                        <option value="Administrator">Successful</option>
                                        <option value="Analyst">Pending</option>
                                        <option value="Developer">Failed/Cancelled</option>
                                    </select>
                                </div>
                                <div class="mb-10">
