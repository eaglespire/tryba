                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#filter">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-550px">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body scroll-y my-7">
                                                <form action="{{route('user.archive.transactions.sort.sclinks')}}" method="post">
                                                    @csrf
                                                    <div class="mb-10">
                                ...
                                Remove from Archive <span id="addx"></span>
                                </button>
                                </form>
                                <!--end::Add user-->
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <span>{{$val->email}}</span>
                                            <span>{{date("Y/m/d h:i:A", strtotime($val->created_at))}}</span>
                                        </div>
                                        <!--begin::User details-->
                                    </td>
                                    <td>@if($val->status==0) 
