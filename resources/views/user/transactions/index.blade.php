...
<div class="toolbar" id="kt_toolbar">
    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-nowrap text-nowrap py-1">
            <a href="{{route('user.transactions.archive')}}" class="btn btn-dark btn-active-primary me-4">{{__('Archived')}} ({{$user->archivedTransactions()}})</a>
        </div>
    </div>
</div>
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-550px">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body scroll-y my-7">
                                        <form action="{{route('user.transactions.sort')}}" method="post">
                                            @csrf
                                            <div class="mb-10">
                        ...
                        <form action="{{route('user.archive.transactions')}}" method="post">
                            ...
                            <button type="submit" disabled id="xx" class="btn btn-primary">
                                ...
                                {{__('Add to Archive')}} <span id="addx"></span>
                            </button>
                        </form>
                        <!--end::Add user-->
                    </div>
                ...
                <table id="kt_datatable_example_5" class="table align-middle table-row-dashed gy-5 gs-7">
                    <thead>
                        <tr class="fw-bolder fs-6 text-gray-800 px-7">
                            ...
                            <th class="min-w-125px">{{__('Payment')}}</th>
