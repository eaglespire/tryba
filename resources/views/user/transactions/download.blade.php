          ...
          <div class="card">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <div class="row justify-content-between align-items-center">
                <div class="col">
                  <div class="my-4">
                    <p class="text-dark">{{__('If you have any questions contact us at')}} <a href="mailto:{{$trans->receiver->support_email}}">{{$trans->receiver->support_email}}</a> {{__('or call at')}} <a href="tel:{{$trans->receiver->phone}}">{{$trans->receiver->phone}}</a>.</p>
                  </div>
                </div>                
              </div>  
            </div>
