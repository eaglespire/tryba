        ...
        <div class="card">
            <div class="card-header card-header-stretch">
                <div class="card-title d-flex align-items-center">
                    <h3 class="fw-bolder m-0 text-dark">{{__('Edit Feature')}}</h3>
                </div>
            </div>
            <form action="{{route('update.feature.store', ['id'=>$val->id])}}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-solid" value="{{$val->title1}}" placeholder="{{__('Text 1')}}" name="title1" required>
                                </div>
                            </div>
                            <div class="row mb-6">
                                <label class="col-lg-3 col-form-label fw-bold fs-6">{{__('Text 2')}}</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-solid" value="{{$val->title2}}" placeholder="{{__('Text 2')}}" name="title2" required>
                                </div>
                            </div>
                            <div class="row mb-6">
