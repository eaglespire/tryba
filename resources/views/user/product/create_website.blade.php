...
<div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
    <div class="container">
        <div class="card">
            ...
            <form action="{{route('submit.website')}}" method="post">
                @csrf
                <div class="card-body px-9 pt-6 pb-4">
                    <div class="d-flex flex-column mb-5 fv-row fv-plugins-icon-container">
                        <label class="required fs-5 fw-bold mb-2">{{__('Title')}}</label>
                        <input type="text" class="form-control form-control-solid" placeholder="{{__('The name of your website')}}" name="store_name" required>
                    </div>
                    <div class="d-flex flex-column mb-5 fv-row fv-plugins-icon-container">
                        <label class="required fs-5 fw-bold mb-2">{{__('Description')}}</label>
                        <textarea class="form-control form-control-solid" rows="5" name="store_desc" type="text" placeholder="{{__('Website Description')}}" required></textarea>
                        <p>This will be displayed in your footer area</p>
                    </div>
                    <div class="d-flex flex-column mb-5 fv-row fv-plugins-icon-container">
                        ...
                        <div class="input-group input-group-solid">
                            ...
                            <input type="text" step="any" required class="form-control form-control-solid slug_input" name="store_url" placeholder="slug">
                        </div>
