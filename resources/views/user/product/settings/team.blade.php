    ...
    <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
            ...
            <ul class="breadcrumb fw-bold fs-base my-1">
                ...
                <li class="breadcrumb-item text-dark">{{__('Team')}}</li>
            </ul>
        </div>
        <div class="d-flex py-2">
            <a href="{{route('add.team.store')}}" class="btn btn-dark me-4"><i class="fal fa-user"></i> {{__('New Team member')}}</a>
        </div>
    </div>
</div>
                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            <table id="kt_datatable_example_6" class="table align-middle table-row-dashed gy-5 gs-7">
                                ...
                                <tbody>
                                    @foreach(getStoreTeam($user->storefront()->id) as $k=>$val)
                                    <tr>
                                        <td>
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3"><a href="{{route('edit.team.store', ['id'=>$val->id])}}" class="menu-link px-3">{{__('Edit')}}</a></div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="{{route('delete.team.store', ['id'=>$val->id])}}" class="btn btn-primary">{{__('Proceed')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
