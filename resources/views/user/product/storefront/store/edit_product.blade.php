...
<div class="toolbar" id="kt_toolbar">
  <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
    ...
    <div class="d-flex py-2">
      <a href="{{route('new.product')}}" class="btn btn-dark btn-active-light me-4">{{__('Add a new product')}}</a>
    </div>
  </div>
</div>
        ...
        <div class="card">
          <div class="card-header py-5 py-md-0 py-lg-5 py-xxl-0">
            ...
            <div class="card-toolbar">
              <a target="_blank" href="{{route('sproduct.link', ['store'=>$store->id,'product'=>$product->ref_id])}}" class="btn btn-info btn-color-light btn-sm">{{__('Preview')}}</a>
            </div>
          </div>
            ...
            <div class="card-body px-9 pt-6 pb-4">
              ...
              <div class="row mb-20">
                ...
                <div class="col-lg-12">
                  ...
                  <div data-toggle="quill" data-quill-placeholder="{{__('Product specification')}}">{!!$product->specification!!}</div>
                </div>
              </div>              
              <div class="row mb-20">
                ...
                <div class="col-lg-12">
                  ...
                  <div data-toggle="quill" data-quill-placeholder="{{__('More details about your product')}}">{!!$product->details!!}</div>
                </div>
              </div>
              <div class="row mb-6">
