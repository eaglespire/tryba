                            ...
                            <form action="{{route('check.product')}}"  id="payment-form" method="post" class="form-default">
                                ...
                                <div class="custom-control custom-control-alternative custom-checkbox mb-6 text-left">
                                    ...
                                    <label class="custom-control-label" for="customCheckLogin">
                                        <p class="">{{__('This transaction requires your consent before continuing and we have selected it for you. Please read')}} <a href="{{route('terms')}}">{{__('Terms & Conditions')}}</a></p>
                                    </label>
                                </div>
                                @if($errors->has('terms'))
