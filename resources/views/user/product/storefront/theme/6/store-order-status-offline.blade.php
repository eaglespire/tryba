...
<div class="tt-breadcrumb">
    <div class="container">
        <ul>
            ...
            <li><a href="{{route('customer.order', ['store_name'=>$store->store_name])}}">{{__('Orders')}}</a></li>
    ...
    <div class="container-indent">
		<div class="container container-fluid-custom-mobile-padding">
            <div class="tt-shopping-layout">
					...
					<table>
						<tbody>
							<tr>
								...
								<td>
									<h2 class="tt-title">
										<a href="{{route('sproduct.link', ['store'=>$store->id,'product'=>$val->product->ref_id])}}">{{$val->product->name}}</a>
									</h2>
				...
				<form action="{{route('product.review', ['store_name'=>$store->store_name])}}" method="post">
					@csrf
