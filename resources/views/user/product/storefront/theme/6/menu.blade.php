...
<head>
	...
	<link rel="stylesheet" href="{{asset('asset/shop/css/style-skin-gothic.css')}}" type="text/css">
	@yield('css')
</head>
...
<body>
										...
										<div class="tt-cart-layout">
											...
											<div class="tt-cart-content">
												...
												<div class="tt-cart-total-row">
													...
													<div class="tt-cart-total-price">{{view_currency(getStorefrontOwner($store->user_id)->coin->coin_id).number_format($gtotal)}}</div>
												</div>
												<div class="tt-cart-btn">
													<div class="tt-item">
														...
														<a href="{{route('user.sask', ['id'=>$val->uniqueid, 'store_url'=>$store->store_url])}}" class="btn">{{__('PROCEED TO CHECKOUT')}}</a>
														@else
							...
							<div class="tt-desctop-menu tt-menu-small">
								<nav>
									...
									<ul>
										...
										@if(getCategory($val->id, $store->user_id, $store->mode)>0)
										<li class="dropdown">
											<a href="{{route('store.cat', ['id' => $store->store_url, 'cat' => $val->id])}}">{{strtoupper($val->name)}}</a>
										</li>
										@endif
										@endforeach
									</ul>
	...
	<footer id="tt-footer">
		<div class="tt-footer-col tt-color-scheme-04">
			<div class="container">
				<div class="row">
			...
			<div class="container">
				<div class="tt-row">
					...
					<div class="tt-col-right">
						<div class="tt-col-item">
							<a href="{{route('terms')}}">{{__('Terms & Conditions')}}</a> | <a href="{{route('privacy')}}">{{__('Privacy policy')}}</a>
						</div>
					</div>
				</div>
				<div class="tt-row">
					<div class="tt-col-left">
						<div class="tt-col-item">
							<!-- copyright -->
							<div class="tt-box-copyright">
								{{__('Store Policy')}}: {!!$store->store_policy!!}
							</div>
							<!-- /copyright -->
						</div>
					</div>
