                ...
                <div class="col-md-12">
                    <div class="content-indent container-fluid-custom-mobile-padding-02">
                        ...
                        <div class="row justify-content-center text-center mt-5">
                            <div class="col">
                                <a href="{{getStoreProductsType($store->user_id, $store->product_per_page)->previousPageUrl()}}" class="fs-6 @if(getStoreProductsType($store->user_id, $store->product_per_page)->previousPageUrl()!=null)text-dark @else disabled @endif"><i class="fal fa-arrow-left"></i> {{__('Previous page')}}</a>
                            </div>
                            <div class="col">
                                <a href="{{getStoreProductsType($store->user_id, $store->product_per_page)->nextPageUrl()}}" class="fs-6 @if(getStoreProductsType($store->user_id, $store->product_per_page)->nextPageUrl()!=null)text-dark @else disabled @endif">{{__('Next page')}} <i class="fal fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
