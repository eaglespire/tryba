                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h2 class="tt-title">
                                        <a href="{{route('sproduct.link', ['id'=>$store->store_url,'product'=>$val->req->ref_id])}}">{{$val->title}}</a>
                                    </h2>
                        ...
                        <div class="tt-shopcart-box">
                            ...
                            <form action="{{route('check.product')}}"  id="payment-form" method="post" class="form-default">
                                ...
                                <div class="text-left">
                                    ...
                                    <p class="text-dark mb-3">{{__('If you don\'t have crypto or you want to buy crypto')}},<a target="_blank" href="{{$set->buy_crypto}}"> {{__('click here')}}</a></p>
                                    @endif
                                    @endif
                                    @endif
                                </div>
                                <div class="text-center mt-6">
                                    <button type="submit" id="ggglogin" class="btn btn-primary btn-block">{{__('Pay')}}</button>
                                </div>
                            </form>
                        </div>
                    </div>
