...
<head>
	...
	@endif
	<link rel="stylesheet" href="{{asset('asset/themes/storefront/shop/css/theme.css')}}" type="text/css">
			...
			<div class="container">
				<div class="tt-header-holder">
					<div class="tt-col-obj tt-obj-logo">
						<a class="tt-logo tt-logo-alignment" href="{{route('store.index', ['id' => $store->store_url])}}">
							@if(getStorefrontOwner($store->user_id)->checkout_logo==null)
							<img src="{{asset('asset/'.$logo->image_link)}}" alt="Tryba">
							@else
							<img src="{{asset('asset/profile/'.getStorefrontOwner($store->user_id)->image)}}" alt="{{$title}}">
											...
											<div class="tt-cart-content">
												<div class="tt-cart-list">
													...
													<div class="tt-item">
														...
														<div class="tt-item-descriptions">
															<a href="{{route('sproduct.link', ['id'=>$store->store_url,'product'=>$val->req->ref_id])}}">
												...
												<div class="tt-cart-btn">
													<div class="tt-item">
														...
														<a href="{{route('user.sask', ['cartid'=>getStorefrontCartFirst($store->id)->uniqueid, 'id'=>$store->store_url])}}" class="btn">{{__('PROCEED TO CHECKOUT')}}</a>
														@else
								...
								<div class="tt-dropdown-menu">
									...
									<div class="tt-dropdown-inner">
										<ul>
											@if (Auth::guard('customer')->check())
											@if($store->id==Auth::guard('customer')->user()->store_id)
											<li><a href="{{route('store.customer.account', ['id'=>$store->store_url])}}"><i class="icon-f-94"></i>{{__('Account')}}</a></li>
											<li><a href="{{route('store.customer.order', ['id'=>$store->store_url])}}"><i class="icon-e-91"></i>{{__('Orders')}}</a></li>
											<li><a href="{{route('store.customer.wishlist', ['id'=>$store->store_url])}}"><i class="icon-n-072"></i>{{__('Wishlist')}} ({{$wishlistcount}})</a></li>
											<li><a href="{{route('store.customer.address', ['id'=>$store->store_url])}}"><i class="icon-f-24"></i>{{__('Address')}}</a></li>
											<li><a href="{{route('store.customer.security', ['id'=>$store->store_url])}}"><i class="icon-f-77"></i>{{__('Security')}}</a></li>
											<li><a href="{{route('store.customer.logout', ['id'=>$store->store_url])}}"><i class="icon-f-84"></i>{{__('Sign Out')}}</a></li>
											@else
											<li><a href="{{route('store.customer.login', ['id'=>$store->store_url])}}"><i class="icon-f-76"></i>{{__('Sign In')}}</a></li>
											<li><a href="{{route('store.customer.register', ['id'=>$store->store_url])}}"><i class="icon-f-94"></i>{{__('Register')}}</a></li>
											<li><a href="{{route('track.order', ['id'=>$store->store_url])}}"><i class="icon-f-24"></i>{{__('Track Order')}}</a></li>
											@endif
											@else
											<li><a href="{{route('store.customer.login', ['id'=>$store->store_url])}}"><i class="icon-f-76"></i>{{__('Sign In')}}</a></li>
											<li><a href="{{route('store.customer.register', ['id'=>$store->store_url])}}"><i class="icon-f-94"></i>{{__('Register')}}</a></li>
							...
							<div class="tt-mobile-collapse">
								...
								<div class="tt-collapse-content">
									<ul class="tt-list">
										...
										<li><a href="{{route('store.customer.order', ['id'=>$store->store_url])}}">{{__('Orders')}}</a></li>
										<li><a href="{{route('store.customer.wishlist', ['id'=>$store->store_url])}}">{{__('Wishlist')}}</a></li>
										<li><a href="{{route('store.customer.address', ['id'=>$store->store_url])}}">{{__('Address')}}</a></li>
										<li><a href="{{route('store.customer.security', ['id'=>$store->store_url])}}">{{__('Security')}}</a></li>
										@else
										<li><a href="{{route('store.customer.login', ['id'=>$store->store_url])}}">{{__('Sign In')}}</a></li>
										<li><a href="{{route('store.customer.register', ['id'=>$store->store_url])}}">{{__('Register')}}</a></li>
										<li><a href="{{route('track.order', ['id'=>$store->store_url])}}">{{__('Track Order')}}</a></li>
										@endif
										@else
										<li><a href="{{route('store.customer.login', ['id'=>$store->store_url])}}">{{__('Sign In')}}</a></li>
										<li><a href="{{route('store.customer.register', ['id'=>$store->store_url])}}">{{__('Register')}}</a></li>
...
<script src="{{asset('asset/themes/storefront/shop/external/jquery/jquery.min.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/slick/slick.min.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/perfect-scrollbar/perfect-scrollbar.min.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/panelmenu/panelmenu.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/rs-plugin/js/jquery.themepunch.tools.min.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/rs-plugin/js/jquery.themepunch.revolution.min.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/countdown/jquery.plugin.min.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/countdown/jquery.countdown.min.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/lazyLoad/lazyload.min.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/js/main.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/magnific-popup/jquery.magnific-popup.min.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/elevatezoom/jquery.elevatezoom.js')}}"></script>
<script src="{{asset('asset/front/js/toast.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/form/jquery.form.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/form/jquery.validate.min.js')}}"></script>
<script src="{{asset('asset/themes/storefront/shop/external/form/jquery.form-init.js')}}"></script>
					...
					<div class="row">
						<div class="col-12 col-lg-6">
							...
							<div class="tt-modal-product">
								...
								<h2 class="tt-title"><a href="{{route('sproduct.link', ['id'=>$store->store_url,'product'=>$xproduct->ref_id])}}">{{$xcart->title}}</a></h2>
								<div class="tt-qty">
