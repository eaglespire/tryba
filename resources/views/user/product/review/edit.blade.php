        ...
        <div class="card">
            <div class="card-header py-5 py-md-0 py-lg-5 py-xxl-0">
                <div class="card-title flex-column">
                    <h3 class="fw-bolder m-0 text-dark">{{__('Edit Review')}}</h3>
                </div>
            </div>
            <div class="card-body px-9 pt-6 pb-4">
                <form action="{{route('update.review.store', ['id'=>$val->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-9">
                            <div class="row mb-6">
                            ...
                            <div class="row mb-20">
                                ...
                                <div class="col-lg-12">
                                    <textarea type="text" class="form-control form-control-solid" rows="4" name="review" required>{{$val->review}}</textarea>
                                </div>
                            </div>
                            <div class="row mb-6">
