  ...
  <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
    <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
      ...
      <ul class="breadcrumb fw-bold fs-base my-1">
        ...
        <li class="breadcrumb-item text-muted">
          <a href="{{route('user.storefront')}}" class="text-muted text-hover-primary">{{__('Website')}}</a>
        </li>
                    ...
                    <td data-bs-toggle="modal" data-bs-target="#order_share{{$val->id}}">
                      <div class="d-flex">
                        <div class="symbol symbol-70px me-6 bg-light">
                          ...
                          @else
                          <img alt="image" src="{{asset('asset/profile/'.getProductImage($val->product->id)->image)}}">
                          @endif
                        </div>
