...
<div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
    <div class="container">
        <div class="card">
            ...
            <form action="{{route('create.slider.store', ['id'=>$user->storefront()->id])}}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-12">
                                    <div class="image-input image-input-empty mb-5" data-kt-image-input-action="change" data-kt-image-input="true" style="background-image: url({{asset('asset/new_dashboard/media/avatars/blank.png')}})">
