 ...
 <h4>Hi {{ $user->first_name }},</h4><br>

@if(strtolower($decision) === 'approved')
<p>Thank you for submitting your documents.</p>
<p>We are currently verifying you documents.</p>
<p>This usually take about 5 minutes. In certain cases we might need up to 48hours to run more checks. We will notify you once they are complete.</p>
