<template>
   <section class="bg-gray-100 top-0 sticky z-50">
      <div class="container overflow-hidden mx-auto lg:py-8 py-4 px-5 lg:px-24">
      <div class="flex justify-between items-center" >
          <div class="" >
               <a href="/"><img :src="asset + 'asset/new_homepage/logo.svg'" class="w-auto h-6 lg:h-6"  alt="tryba"></a>
          </div>
          ...
          <div id="mobileNavIcon" class="lg:hidden">
          ...
          <div class="hidden lg:flex space-x-4">
            <div>
              <a v-if="!loggedIn" href="javascript:void(0)" @click="openRegisterModal" class="border-brand border py-3 font-medium lg:px-6 px-4 text-sm lg:text-base rounded-md lg:rounded-lg text-brand transition duration-300  hover:opacity-70">Sign up</a>
              <a v-else href="register" class="border-brand border py-3 font-medium lg:px-6 px-4 text-sm lg:text-base rounded-md lg:rounded-lg text-brand transition duration-300  hover:opacity-70">Sign up</a>
            </div>
            <div>
