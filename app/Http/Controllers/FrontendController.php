...
class FrontendController extends Controller
{
    ...
    {
        $data['title'] = "Pricing";
        $data['sxf']=Countrysupported::wherestatus(1)->get();
        $data['plans'] = SubscriptionPlan::all();
        return view('front.index2', $data);
    }
    ...
    public function modulrterms()
    {
        $data['title'] = "Modulr Terms & conditions";
        return view('front.modulrterms', $data);
    }    
    ...
    public function contactSubmit(Request $request)
    {
        ...
        $sav['seen'] = 0;
        Contact::create($sav);
        return back()->with('toast_success', ' Message was successfully sent!');
    }
