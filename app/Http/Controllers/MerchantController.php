...
class MerchantController extends Controller
{
    ...
    public function merchantlog()
    {
        ...
        $data['merchant'] = Merchant::wheremode(1)->orderBy('id', 'DESC')->with('user')->paginate(10);
    ...
    public function transferlog($id)
    {
        ...
        $data['transfer']=Exttransfer::wheremerchant_key($id)->orderBy('id', 'DESC')->paginate(10);
    ...
    public function approve($id)
    {
        ...
        return back()->with('toast_success', 'Merchant is now active.');
    } 
    ...
    public function decline($id)
    {
        ...
        return back()->with('toast_success', 'Merchant has been disabled.');
    }
