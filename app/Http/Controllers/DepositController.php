 ...
 public function bankdetails(Request $request)
    ...
    public function approvebk($id)
    {
        ...
        if($set->email_notify==1){
            send_email(
                ...
                'Transaction Reference: '.$data->trx.'<br>Amount: '.$currency->coin->symbol.$data->amount.'<br>Charge: '.$currency->coin->symbol.$data->charge.'<br>Thanks for working with us.'
            );
        }
        if ($res) {
    ...
    public function declinebk($id)
    {
        ...
        if ($res) {
            ...
            return back()->with('toast_warning', 'Problem With Declining Request');
        }
    }   
