  ...
  data: function data() {
    return {
      firstSlides: [{
        ...
        content: "Choose from tryba’s numerous business tools like web and eStore builder etc. to setup your business quickly.",
        ...
        name: "Instant Payout",
        content: "We use End-to-End Open banking technology to ensure funds are instantly settled in tryba’s bank account.",
      ...
      secondSlides: [{
        ...
        content: "Get the best of tryba’s payment link, invoice, expense and budgeting tools for your business.",
        show: true
      }, {
        ...
        content: 'Tryba’s business bank accounts with virtual and physical cards designed to grow with your business.',
        show: false
      }, {
        name: "Merchant",
        bg: "second-fouth-slide",
        image: "undraw_business_deal_re_up4u 1.png",
        content: "Build tryba’s functionalities into your existing workflow and unlock business potentials like never before.",
        show: false
      }]
    };
  },
  ...
  data: function data() {
    return {
      slides: [{
        ...
        content: "Gain access to tryba’s all in one business tools for the success of your business.",
...
}, "Enabled by Modulr FS Ltd for the provision of tryba’s business accounts and cards", -1
/* HOISTED */
);
...
}, "Tryba’s business accounts and cards are designed to give you flexibility, allowing you to focus on your business.", -1
/* HOISTED */
);
...
}, "Launch a complete business on the tryba’s ecosystem, with tools like web and store builder, invoicing, payment links etc.", -1
/* HOISTED */
);
