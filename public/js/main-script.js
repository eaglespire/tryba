...
$(document).ready(function(e) {
  ...
  //   $("#mccModal").modal({show: true, backdrop: 'static'})
    ...
    //     let value = $(this).val()
    //     if(value == '') { return }
    //     axios.get('/api/compliance-verification/company-data/'+value)
    //     .then(response => {
    ...
    //         $.each(data, function(index, value) {
    //           html =
    //           `<option value="${value.title}" data-cid="${value.company_number}" >
    //             ${value.title+' - '+value.company_number}
    //           </option>`
    ...
    $(".business_name").on("change", function(e) {
        ...
        .then(response => {
            ...
            formdata.registeredAddress = {
                "addressLine1": ar[0].address_snippet,
            ...
            $.each(response.data.items, function(index, officer) {
              ...
              htm =  `
                    <div class="mt-4">
                        <div class="fw-boldest fs-6">${officer.occupation}</div>
                            <div class="mt-4">
