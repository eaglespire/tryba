 ...
 * */
 ...
 function MenuEditor(idSelector, options) {
     ...
     var settings = {
         labelEdit: '<i class="fal fa-edit clickable"></i>',
         labelRemove: '<i class="fal fa-trash-alt clickable"></i>',
         ...
         listOptions: { 
             ...
             opener: {
                 as: 'html',
                 close: '<i class="fal fa-minus"></i>',
                 open: '<i class="fal fa-plus"></i>',
     ...
     function TButtonGroup() {
         ...
         var $btnUp = TButton({classCss: 'btn btn-secondary btn-sm btnUp btnMove', text: '<i class="fal fa-angle-up clickable"></i>'});
         var $btnDown = TButton({classCss: 'btn btn-secondary btn-sm btnDown btnMove', text: '<i class="fal fa-angle-down clickable"></i>'});
         var $btnOut = TButton({classCss: 'btn btn-secondary btn-sm btnOut btnMove', text: '<i class="fal fa-level-down-alt clickable"></i>'});
         var $btnIn = TButton({classCss: 'btn btn-secondary btn-sm btnIn btnMove', text: '<i class="fal fa-level-up-alt clickable"></i>'});
