    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_header")) &&
                KTSticky.getInstance(e).on("kt.sticky.change", function () {
                    setTimeout(function () {
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_header_search")) &&
                ...
                (t = e.querySelector('[data-kt-search-element="recently-viewed"]')),
                ...
                (s = new KTSearch(e)).on("kt.search.process", u),
                s.on("kt.search.clear", d),
